...
func set_spritesheet():
	var path = "res://Nodes/Overworld/Enemies/Gorilla2OV.png"
...
func _on_SpawnArea_body_exited(body):
	if body == global.persistPlayer and firstAppearance:
		...
		audioManager.play_music_from_id("PassiveHeal.mp3", "PassiveHeal.mp3", audioManager.get_audio_player_count() - 1)
		start_chase()
